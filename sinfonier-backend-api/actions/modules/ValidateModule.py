...
from error.ErrorHandler import Error, ModuleVersionInvalidId, ModuleException, ModuleErrorCompilingException, MissingMandatoryFields, \
    ModuleInvalidLanguage, ModuleInvalidId
    ...
    def on_post(self, req, res, id, version_id):
        ...
        try:
            ...
            if not module_version[ModuleVersionConst.FIELD_SOURCE_CODE]:
                raise ModuleException('The module\'s ' + ModuleVersionConst.FIELD_SOURCE_CODE + ' is mandatory.')
